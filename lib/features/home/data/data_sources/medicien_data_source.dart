...
abstract class MedicineDataSource {
  Future<Either<FailureError, List<SelectedCategoryItemModel>>>getMedicinesByCategoryId(
      { required String id});
}
...
class RemoteMedicineDataSource implements MedicineDataSource{
  @override
  Future<Either<FailureError, List<SelectedCategoryItemModel>>> getMedicinesByCategoryId({ required String id}) async {
   ApiServices apiServices = ApiServices();

   try{

     var response  =  await apiServices.get(url: EndPoints.baseUrl + EndPoints.getMedicinesByCategoryId + id);
...
class LocalMedicineDataSource implements MedicineDataSource{
  @override
  Future<Either<FailureError, List<SelectedCategoryItemModel>>> getMedicinesByCategoryId({ required String id}) {
